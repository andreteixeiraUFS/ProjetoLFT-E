...
public final class ACaractereTipoVariavel extends PTipoVariavel
{
    private TCaractere _caractere_;

    public ACaractereTipoVariavel()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ACaractereTipoVariavel(
    ...
    {
        ((Analysis) sw).caseACaractereTipoVariavel(this);
    }
