...
class TokenIndex extends AnalysisAdapter
{
    ...
    @Override
    public void caseTParenEsq(@SuppressWarnings("unused") TParenEsq node)
    {
        this.index = 4;
    }

    @Override
    public void caseTParenDir(@SuppressWarnings("unused") TParenDir node)
    {
        this.index = 5;
    }
    ...
    @Override
    public void caseTFimP(@SuppressWarnings("unused") TFimP node)
    {
        this.index = 42;
    }
